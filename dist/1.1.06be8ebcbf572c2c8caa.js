...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/routes/Home/components/HomeView.vue: named exports in *.vue files are ignored.")}
	...
	if (true) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-a730c698/HomeView.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".duck {\n  display: block;\n  width: 120px;\n  margin: 1.5rem auto;\n}", "", {"version":3,"sources":["/./src/routes/Home/components/styles.css"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,aAAa;EACb,oBAAoB;CACrB","file":"styles.css","sourcesContent":[".duck {\n  display: block;\n  width: 120px;\n  margin: 1.5rem auto;\n}"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      DuckImage: __webpack_require__(545)
	    };
	  },
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"duck\">\n  <h4>Welcome!</h4>\n  <img alt='This is a duck, because Vuex!' :src='DuckImage' />\n  <div @click=\"ppclick\">pp</div>\n</div>\n";

/***/ }

});
//# sourceMappingURL=1.1.06be8ebcbf572c2c8caa.js.map